    ...
    >
      ...
      >
        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-sm bg-muted">
          ...
          <span className="absolute left-2.5 top-2.5 rounded-full bg-background/90 px-2.5 py-1 text-[11px] font-medium text-primary shadow-soft backdrop-blur-sm">
            ✨ Dream
          </span>
        </div>
